...
namespace ExpenseTracker
{
    ...
    public class ExpenseTrackerCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ExpenseTrackerLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            SimpleStringCipher.DefaultPassPhrase = ExpenseTrackerConsts.DefaultPassPhrase;
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(ExpenseTrackerCoreModule).GetAssembly());
        }
