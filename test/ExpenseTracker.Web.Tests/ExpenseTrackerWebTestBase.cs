...
using ExpenseTracker.Models.TokenAuth;
...
{
    public abstract class ExpenseTrackerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExpenseTrackerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExpenseTrackerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ExpenseTrackerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ExpenseTrackerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExpenseTrackerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExpenseTrackerDbContext, Task<T>> func)
        {
            T result;
